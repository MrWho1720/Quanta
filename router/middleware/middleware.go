...
func RequireAuthorization() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		// All requests to Quanta must be authorized with the authentication token present in
		// the Quanta configuration file. Remeber, all requests to Quanta come from the Panel
