...
import (
	...
	"github.com/quantum/quanta/router/downloader"
	"github.com/quantum/quanta/router/middleware"
	"github.com/quantum/quanta/router/tokens"
...
func getServerFileContents(c *gin.Context) {
	...
	//
	// @see https://github.com/quantum/panel/issues/4059
	...
	//
	// @see https://github.com/quantum/panel/issues/3131
...
func postServerDecompressFiles(c *gin.Context) {
	...
	if err != nil {
		if filesystem.IsErrorCode(err, filesystem.ErrCodeUnknownArchive) {
			...
			c.AbortWithStatusJSON(http.StatusBadRequest, gin.H{"error": "The archive provided is in a format Quanta does not understand."})
			return
		}
		middleware.CaptureAndAbort(c, err)
		return
