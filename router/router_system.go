...
import (
	...
	"github.com/quantum/quanta/server/installer"
	"github.com/quantum/quanta/system"
)

// Returns information about the system that quanta is running on.
...
// Creates a new server on the quanta daemon and begins the installation process
// for it.
...
// Updates the running configuration for this Quanta instance.
