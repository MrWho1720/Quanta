...
import (
	...
	"github.com/quantum/quanta/internal/ufs"
)
...
type ConfigurationFile struct {
	...
	// Tracks Quanta' configuration so that we can quickly get values
...
//
// @see https://github.com/quantum/panel/issues/2308 (original)
// @see https://github.com/quantum/panel/issues/3009 ("bug" introduced as result)
