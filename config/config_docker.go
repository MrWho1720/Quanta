...
type DockerNetworkConfiguration struct {
	...
	// defined.
	Name       string                  `default:"quantum_nw"`
	ISPN       bool                    `default:"false" yaml:"ispn"`
	Driver     string                  `default:"bridge"`
	Mode       string                  `default:"quantum_nw" yaml:"network_mode"`
	IsInternal bool                    `default:"false" yaml:"is_internal"`
	EnableICC  bool                    `default:"true" yaml:"enable_icc"`
	NetworkMTU int64                   `default:"0" yaml:"network_mtu"`
...
type DockerConfiguration struct {
	...
	// if the value is "host", then the quantum containers are started with user namespace
	// remapping disabled
